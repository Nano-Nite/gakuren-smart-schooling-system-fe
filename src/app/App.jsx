...
import StudentManagement from '../features/students/pages/StudentManagement'
import TeacherStaffManagement from '../features/teachers-staff/pages/TeacherStaffManagement'
import QrCodeManagement from '../features/qr-code/pages/QrCodeManagement'
import ApprovalManagement from '../features/approvals/pages/ApprovalManagement'
import AppLayout from './layouts/AppLayout'
import Profile from '../features/profile/pages/Profile'
import SignUp from '../features/auth/pages/SignUp'
import ModulePlaceholder from './pages/ModulePlaceholder'
import SubmenuPage, { SubmenuContent } from './pages/SubmenuPage'
import { getDefaultAuthorizedRoute } from '../shared/utils/permissions'
import { initializeAuth, isNetworkAvailable, isUserAuthenticated, setNetworkAvailable } from '../shared/utils/api'
import { getMenuItems, getMenuPermissions, hasAnyPermission, hasMenuAccess, hasChildMenuAccess, CHILD_MENUS, MENU_ROUTES } from '../shared/utils/permissions'
import AccessDenied from './pages/AccessDenied'
import OfflineUnavailable from './pages/OfflineUnavailable'
import SessionSplash from '../shared/components/SessionSplash'
import { LoginSplashProvider } from '../shared/context/LoginSplashContext'
import { withMinimumDuration } from '../shared/utils/withMinimumDuration'
