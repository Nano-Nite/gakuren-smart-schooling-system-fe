...
import { CHILD_MENUS, getMenuChildren, hasChildMenuAccess } from "../../shared/utils/permissions";
import ModulePlaceholder from "./ModulePlaceholder";
import LocationSettings from "../../features/settings/location/pages/LocationSettings";
import DeviceSettings from "../../features/settings/device/pages/DeviceSettings";
...
export function SubmenuContent({ parent, child }) {
  ...
  return selected ? hasChildMenuAccess(parent, selected)
    ? parent === "Setting" && selected === "Location" ? <LocationSettings /> : parent === "Setting" && selected === "Device" ? <DeviceSettings /> : <ModulePlaceholder title={selected} />
