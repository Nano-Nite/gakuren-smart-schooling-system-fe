...
export default function TeacherStaffManagement() {
  ...
  const saveEdit = async event => {
    ...
    try {
      ...
      const outcome = getTeacherStaffCreateOutcome(response);
      setNotice({ pending: outcome.pending, message: outcome.pending ? "Pengajuan perubahan berhasil dikirim dan menunggu persetujuan." : "Perubahan berhasil dikirim. Data terbaru dimuat dari server." });
      setSelected(null);
      setRefreshKey(value => value + 1);
    } catch (requestError) {
