...
export default function OfflineUnavailable({ menu }) {
  return <>
    <Helmet><title>{menu} Tidak Tersedia — Gakuren</title></Helmet>
    <div className="grid min-h-full place-items-center p-4 sm:p-6">
      <section className="w-full max-w-xl rounded-2xl border border-rose-200 bg-white p-7 text-center sm:p-10">
        ...
        <h2 className="mt-4 text-xl font-bold">{menu} memerlukan koneksi internet</h2>
        <p className="mx-auto mt-3 max-w-md text-sm leading-6 text-slate-500">Menu ini dinonaktifkan saat offline untuk menjaga konsistensi dan keamanan data sekolah.</p>
